...
use frontend\models\FindDish;
use frontend\models\ResendVerificationEmailForm;
use frontend\models\VerifyEmailForm;
use frontend\modules\dish\models\Dish;
...
class SiteController extends Controller
{
    ...
    public function behaviors()
    {
        return [
            'access' => [
                ...
                'only' => ['logout', 'signup', 'product', 'dish'],
                'rules' => [
                    [
                        'actions' => ['signup'],
                        'allow' => true,
    ...
    public function actionIndex()
    {
        ...
        if($request->isPost && $model->validate()) {
            $post = $request->post();
            if(count($post['Dish']['ingridients']) < 2) {
            ...
            $dataProvider = $search->SearchDish($post['Dish']['ingridients']);
    ...
    {
        return $this->redirect('/dish/dish');
    }
}
